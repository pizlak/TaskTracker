                            ...
                            <div class="col-2  text-center">
                                <div class="square-img">
                                    <img class="w-100 h-100 rounded-circle"
                                         src="{{ asset('storage/' . $user->images()->latest()->first()->photo ) }}" alt="">
                                </div>
                            </div>
                            <div class="col-5 ">
                                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <select name="day_of_birth" class="form-select text-center">
                                            <option value="{{ $user->day_of_birth }}">{{ $user->day_of_birth }}</option>
                                            <hr>
                                    ...
                                    <div class="col">
                                        <select name="month_of_birth" class="form-select text-center">
                                            <option value="{{ $user->month_of_birth }}">{{ $user->month_of_birth }}</option>
                                            <hr>
                                    ...
                                    <div class="col">
                                        <select name="years_of_birth" class="form-select text-center">
                                            <option value="{{ $user->years_of_birth }}">{{ $user->years_of_birth }}</option>
                                            <hr>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('profile.edit.password') }}">
                            ...
                            <div class="mb-3 row">
                                ...
                                <label class="col-sm-3 col-form-label mt-1"><strong>Повторите новый
                                        пароль</strong></label>
